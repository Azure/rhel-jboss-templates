...
cat <<EOF > ${parametersPath}
{
    ...
    "parameters": {
        "artifactsLocation": {
            "value": "https://raw.githubusercontent.com/${gitUserName}/rhel-jboss-templates/${testbranchName}/eap-rhel-payg-vmss/"
        },
        "location": {
            "value": "${location}"
        },
