...
module baseImageSelected './modules/_pids/_empty.bicep' = {
  name: (jdkVersion == 'openjdk8') ? '${azure.guid.eap-rhel-payg-multivm.rh-jboss-eap74-jdk8-rhel8}' : (jdkVersion == 'openjdk11') ? '${azure.guid.eap-rhel-payg-multivm.rh-jboss-eap74-jdk11-rhel8}' : (jdkVersion == 'openjdk17') ? '${azure.guid.eap-rhel-payg-multivm.rh-jboss-eap74-jdk17-rhel8}' :  'eap74-rhel8-payg.null'
  params: {}
}
...
*/    domainmode ? '' : format('http://{0}:9990', publicIp[i].properties.ipAddress)                                              /*
*/ ]
