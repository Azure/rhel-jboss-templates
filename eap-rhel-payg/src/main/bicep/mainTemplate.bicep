...
module baseImageSelected './modules/_pids/_empty.bicep' = {
  name:(jdkVersion == 'eap74-openjdk8') ? '${azure.guid.eap-rhel-payg.rh-jboss-eap74-jdk8-rhel8}' : /*
     ...
     */(jdkVersion == 'eap8-openjdk11') ? '${azure.guid.eap-rhel-payg.rh-jboss-eap8-jdk11-rhel9-gen2}' : /*
     */(jdkVersion == 'eap8-openjdk17') ? '${azure.guid.eap-rhel-payg.rh-jboss-eap8-jdk17-rhel9-gen2}' : /*
     */'eap-rhel-payg.null'
  params: {}
}
