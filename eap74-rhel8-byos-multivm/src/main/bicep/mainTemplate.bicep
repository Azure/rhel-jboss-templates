...
output adminConsoles array = [for i in range(0, numberOfInstances): domainmode ? '' : uri('http://${reference(resourceId('Microsoft.Network/networkInterfaces', '${nicName_var}${i}')).ipConfigurations[0].properties.privateIPAddress}:9990', '') ]
