...
output appHttpURL string = uri(format('http://{0}/', vmPublicIP.properties.dnsSettings.fqdn, ''))
output appHttpsURL string = uri(format('https://{0}/', vmPublicIP.properties.dnsSettings.fqdn, ''))
