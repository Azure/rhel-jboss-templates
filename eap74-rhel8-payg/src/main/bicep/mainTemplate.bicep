...
output appHttpURL string = format('http://{0}/', vmPublicIP.properties.dnsSettings.fqdn)
output appHttpsURL string = format('https://{0}/', vmPublicIP.properties.dnsSettings.fqdn)
output adminConsole string = format('http://{0}:9990/', vmPublicIP.properties.dnsSettings.fqdn)
